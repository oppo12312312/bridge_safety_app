	...
	<view>
		<view class="page-body">
			<view class="page-section page-section-gap">
				<map id="map" ref="map" :show-location="true" style="width: 100%; height: 300px;" :markers="covers" :latitude="latitude" :longitude="longitude"></map>
			</view>
			<view class="db location">
				<image class="img" src="../../static/home/location.png" mode=""></image>
				<view class="name fx1">{{ locationName }}</view>
				<view class="reset" @click="getLocation">重新定位</view>
			</view>

			<view class="upload">
				<view class="title">上传图片：</view>
				<view class="demo">
					<block v-if="imageSrc"><image :src="imageSrc" @click="chooseImage" class="image-up" mode="widthFix"></image></block>
					<block v-else>
						<view class="img-b" @click="chooseImage"><image class="image" src="../../static/jia.png" mode=""></image></view>
					</block>
				</view>
			</view>
			...
			<view class="text">
				...
				<view class="uni-textarea"><textarea v-model="text" placeholder="请输入备注" /></view>
			</view>
		...
		getLocation() {
			...
			uni.getLocation({
				...
				success: function(res) {
					...
					let poi = sys.platform === "ios"? res.address.streetNum : res.address.poiName;
					if(!poi){
						poi = "";
					}
